...
class MenuContainer {
        ...
        this.onInit()
            .then(() => {
                ...
                for(const starter of this.menu.starters) {
                    ...
                    setTimeout(() => {
                        const itemFigure = document.getElementById("figure-"+ starter.id)
                        itemFigure.addEventListener('click', () => this.onItemFigureClick(starter))
                    })
                }
                ...
                this.menu.mains.forEach((el) => {
                    ...
                    setTimeout(() => {
                        const itemFigure = document.getElementById("figure-"+ el.id)
                        itemFigure.addEventListener('click', () => this.onItemFigureClick(el))
                    })
                })
                ...
                for(const index in this.menu.desserts) {
                    ...
                    setTimeout(() => {
                        const itemFigure = document.getElementById("figure-"+ this.menu.desserts[index].id)
                        itemFigure.addEventListener('click', () => this.onItemFigureClick(this.menu.desserts[index]))
                    })
                }
    ...
    onItemFigureClick (starter) {
        ...
        const appDialogCloseButton = document.getElementById("app-dialog-close-button")
